...
def run_pipeline():
    ...
    # ── Variablen VOR dem try-Block initialisieren (verhindert UnboundLocalError) ──
    artifact = {
        "run_id": run_id,
        "version": "3.2-final",
        "data_health": {},
    ...
    try:
        ...
        # ... (Rest des Codes bleibt unverändert – Stage 4 bis Stage 8)

        print("\nStage 4: Quantitative models + real option history...")
        # [Der gesamte Rest der Pipeline (Stage 4–8) bleibt exakt wie bisher – ich habe ihn hier aus Platzgründen nicht nochmal reingekopiert, damit du nur die wichtigen Teile änderst]

        # (Der Rest des try-Blocks bleibt identisch mit deiner aktuellen main.py ab Zeile 149)
        ...
        # ── Immer ausführen – auch bei frühem Exit ──
        ...
        artifact["m2_growth"] = 0  # wird später gesetzt, wenn möglich
